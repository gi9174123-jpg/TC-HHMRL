...
def test_benchmark_supports_ablations_and_learning_baseline(tmp_path: Path):
    ...
    for col in [
        ...
        "projection_compression_ratio_per_source_tx0",
        "projection_compression_ratio_per_source_tx1",
        "projection_compression_ratio_per_source_tx2",
        "qos_recovered_current",
        "execution_guard_enabled",
        "execution_guard_applied",
        "execution_guard_downgrade_applied",
        "execution_guard_anchor_clamp_applied",
        "execution_guard_downgrade_ld1",
        "execution_guard_downgrade_ld2",
        "execution_guard_candidate_count",
        "execution_guard_selected_score",
        "execution_guard_rescue_to_ld1",
        "execution_guard_rescue_to_ld2",
        "execution_guard_rescue_to_all",
        "execution_guard_fallback_anchor",
        "execution_guard_clamp_ld1",
        "execution_guard_clamp_ld2",
        "execution_guard_remove_ld1",
        "execution_guard_remove_ld2",
