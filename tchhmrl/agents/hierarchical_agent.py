    ...
    def act(
        ...
        aux = {
            ...
            **planner_aux,
            ...
            "execution_guard_enabled": safe.get("execution_guard_enabled", False),
            "execution_guard_applied": safe.get("execution_guard_applied", False),
            "execution_guard_downgrade_applied": safe.get("execution_guard_downgrade_applied", False),
            "execution_guard_anchor_clamp_applied": safe.get("execution_guard_anchor_clamp_applied", False),
            "execution_guard_requested_boost": safe.get("execution_guard_requested_boost", safe.get("boost_combo_exec", 0)),
            "execution_guard_final_boost": safe.get("execution_guard_final_boost", safe.get("boost_combo_exec", 0)),
            "execution_guard_downgrade_ld1": safe.get("execution_guard_downgrade_ld1", 0.0),
            "execution_guard_downgrade_ld2": safe.get("execution_guard_downgrade_ld2", 0.0),
            ...
            "execution_guard_candidate_count": safe.get("execution_guard_candidate_count", 0),
            "execution_guard_selected_score": safe.get("execution_guard_selected_score"),
            "execution_guard_rescue_to_ld1": safe.get("execution_guard_rescue_to_ld1", 0.0),
            "execution_guard_rescue_to_ld2": safe.get("execution_guard_rescue_to_ld2", 0.0),
            "execution_guard_rescue_to_all": safe.get("execution_guard_rescue_to_all", 0.0),
            "execution_guard_fallback_anchor": safe.get("execution_guard_fallback_anchor", 0.0),
            "execution_guard_clamp_ld1": safe.get("execution_guard_clamp_ld1", 0.0),
            "execution_guard_clamp_ld2": safe.get("execution_guard_clamp_ld2", 0.0),
            "execution_guard_remove_ld1": safe.get("execution_guard_remove_ld1", 0.0),
            "execution_guard_remove_ld2": safe.get("execution_guard_remove_ld2", 0.0),
